...
namespace StarcraftEPDTriggers {
    ...
    public partial class WndAdvancedUnitProperties : Window {
        ...
        private void setup() {
            ...
            txtSingleEntity.ToolTip = "Unit cannot be selected in a group, but only as a single unit. Unit cannot be selected by dragging a selection box, by a SHIFT-Click nor a double-click.";
