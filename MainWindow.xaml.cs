...
namespace StarcraftEPDTriggers {
    ...
    public delegate void MyFocuser();
    ...
    public partial class MainWindow : Window {
        ...
        private string getSaveString(bool readable) {
            StringBuilder sb = new StringBuilder();
            foreach (Trigger trigger in Triggers.AllTrigers) {
                sb.Append(trigger.ToSaveString(readable));
                sb.Append("\r\n");
            }
            return sb.ToString();
        }
        ...
        private void btnCopy_Click(object sender, RoutedEventArgs e) {
            ...
            if (sel != null) {
                Trigger trigger = ((object[]) sel.CustomData)[1] as Trigger;
                string textTrig = trigger.ToSaveString(false);
